...
class TestSquareInstantiation(unittest.TestCase):
    ...
    def test_size_getter(self):
        self.assertEqual(10, Square(10, 2, 3, 9).size)
...
class TestSquare_x(unittest.TestCase):
    ...
    def test_bytearray_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(1, x=bytearray(b'abcdefg'))

    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(1, x=memoryview(b'abcedfg'))

    def test_inf_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(1, x=float('inf'))

    def test_nan_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(1, x=float('nan'))
...
class TestSquare_y(unittest.TestCase):
    ...
    def test_bytearray_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, y=bytearray(b'abcdefg'))

    def test_memoryview_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, y=memoryview(b'abcedfg'))

    def test_inf_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, y=float('inf'))

    def test_nan_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, y=float('nan'))
...
class TestSquareUpdateArgs(unittest.TestCase):
    ...
    def test_update_args_one(self):
        s = Square(5, 5, 5, 5)
        s.update(8)
        self.assertEqual("[Square] (8) 5/5 - 5", str(s))

    def test_update_args_two(self):
        s = Square(5, 5, 5, 5)
        s.update(8, 2)
        self.assertEqual("[Square] (8) 5/5 - 2", str(s))

    def test_update_args_three(self):
        s = Square(5, 5, 5, 5)
        s.update(8, 2, 3)
        self.assertEqual("[Square] (8) 3/5 - 2", str(s))

    def test_update_args_four(self):
        s = Square(5, 5, 5, 5)
        s.update(8, 2, 3, 4)
        self.assertEqual("[Square] (8) 3/4 - 2", str(s))
    ...
    def test_update_args_None_id_and_more(self):
        s = Square(5, 5, 5, 5)
        s.update(None, 4, 5)
        correct = "[Square] ({}) 5/5 - 4".format(s.id)
        self.assertEqual(correct, str(s))
    ...
    def test_update_args_twice(self):
        ...
        s.update(8, 2, 3, 4)
        s.update(4, 3, 2, 8)
        self.assertEqual("[Square] (4) 2/8 - 3", str(s))
    ...
    def test_update_args_size_before_x(self):
        s = Square(5, 5, 5, 5)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(8, "invalid", "invalid")

    def test_update_args_size_before_y(self):
        s = Square(5, 5, 5, 5)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(8, "invalid", 2, "invalid")

    def test_update_args_x_before_y(self):
        s = Square(5, 5, 5, 5)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            s.update(8, 1, "invalid", "invalid")
...
class TestSquareUpdateKwargs(unittest.TestCase):
    ...
    def test_update_kwargs_two(self):
        ...
        self.assertEqual("[Square] (2) 5/5 - 1", str(s))

    def test_update_kwargs_three(self):
        s = Square(5, 5, 5, 5)
        s.update(y=1, size=3, id=8)
        self.assertEqual("[Square] (8) 5/1 - 3", str(s))

    def test_update_kwargs_four(self):
        s = Square(5, 5, 5, 5)
        s.update(id=8, x=1, y=3, size=4)
        self.assertEqual("[Square] (8) 1/3 - 4", str(s))

    def test_update_kwargs_width_setter(self):
        s = Square(5, 5, 5, 5)
        s.update(id=8, size=6)
        self.assertEqual(6, s.width)

    def test_update_kwargs_height_setter(self):
        s = Square(5, 5, 5, 5)
        s.update(id=8, size=7)
    ...
    def test_update_kwargs_None_id_and_more(self):
        s = Square(5, 5, 5, 5)
        s.update(id=None, size=7, x=15)
        correct = "[Square] ({}) 15/5 - 7".format(s.id)
        self.assertEqual(correct, str(s))
    ...
    def test_update_kwargs_twice(self):
        ...
        self.assertEqual("[Square] (8) 15/3 - 2", str(s))
