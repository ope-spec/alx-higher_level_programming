...
class TestRectangleInstantiation(unittest.TestCase):
    ...
    def test_three_args(self):
        r1 = Rectangle(10, 10, 20)
        r2 = Rectangle(20, 20, 10)
        self.assertEqual(r1.id, r2.id - 1)

    def test_four_args(self):
        r1 = Rectangle(5, 10, 15, 20)
        r2 = Rectangle(20, 15, 10, 5)
        self.assertEqual(r1.id, r2.id - 1)

    def test_five_args(self):
        self.assertEqual(7, Rectangle(5, 10, 0, 0, 7).id)
...
class TestRectangleWidth(unittest.TestCase):
    ...
    def test_frozenset_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(frozenset({1, 2, 3, 1}), 10)

    def test_range_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(range(5), 10)

    def test_bytes_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(b'Python', 10)

    def test_bytearray_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(bytearray(b'abcdefg'), 10)

    def test_memoryview_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(memoryview(b'abcedfg'), 10)
...
class TestRectangleArea(unittest.TestCase):
    ...
    def test_area_small(self):
        r = Rectangle(5, 4, 0, 0, 0)
        self.assertEqual(20, r.area())

    def test_area_large(self):
        r = Rectangle(999, 9999, 0, 0, 1)
        self.assertEqual(9989001, r.area())

    def test_area_changed_attributes(self):
        r = Rectangle(7, 14, 1, 1, 1)
        r.width = 10
        r.height = 7
...
class TestRectangleStdout(unittest.TestCase):
    ...
    def test_str_method_changed_attributes(self):
        ...
        r.x = 5
        r.y = 9
        self.assertEqual("[Rectangle] ([4]) 5/9 - 12/3", str(r))
...
class TestRectangleUpdateArgs(unittest.TestCase):
    ...
    def test_update_args_one(self):
        r = Rectangle(5, 5, 5, 5, 5)
        r.update(89)
        self.assertEqual("[Rectangle] (89) 5/5 - 5/5", str(r))
    ...
    def test_update_args_three(self):
        r = Rectangle(5, 5, 5, 5, 5)
        r.update(89, 2, 3)
        self.assertEqual("[Rectangle] (89) 5/5 - 2/3", str(r))
...
class TestRectangleUpdateKwargs(unittest.TestCase):
    ...
    def test_update_kwargs_some_wrong_keys(self):
        ...
        self.assertEqual("[Rectangle] (89) 19/7 - 5/5", str(r))
...
class TestRectangleToDictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        r = Rectangle(8, 4, 2, 6, 10)
        correct = {'x': 2, 'y': 6, 'id': 10, 'height': 4, 'width': 8}
        self.assertDictEqual(correct, r.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        r1 = Rectangle(8, 4, 2, 6, 10)
        r2 = Rectangle(5, 9, 1, 2, 10)
        r2.update(**r1.to_dictionary())
        self.assertNotEqual(r1, r2)

    def test_to_dictionary_arg(self):
        r = Rectangle(8, 4, 3, 2, 7)
        with self.assertRaises(TypeError):
            r.to_dictionary(1)
